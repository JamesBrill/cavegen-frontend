...
CaveChangeHistory.prototype.numberOfChanges = function () {
...
CaveChangeHistory.prototype.atBeginningOfHistory = function () {
  return this.currentChangeIndex === -1
}

CaveChangeHistory.prototype.atEndOfHistory = function () {
...
CaveChangeHistory.prototype.getTileChanges = function (index) {
